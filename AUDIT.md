...
| L13 | 🔵 Low | Frontend/a11y | Signature canvas has no `aria-label`/typed-name fallback | Open |
| L14 | 🔵 Low | Correctness | `decimal-hours` 24h input wraps to `00:00`/`00:00` | Open |
