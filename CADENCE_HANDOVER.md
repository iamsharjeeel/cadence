...
- `useState(PROJECT_PRESET_COLORS[0])` → `useState<string>(PROJECT_PRESET_COLORS[0] ?? "#B8862F")`.
...
- Migration: `supabase/migrations/20260619000000_task_c_resubmit_count.sql` (applied).
...
- `supabase/migrations/20260619000000_task_c_resubmit_count.sql` — C2 migration (applied)
